...
namespace Task08.Migrations
{
    ...
    [Migration("20230117210523_addedUserTable")]
            ...
            modelBuilder.Entity("Task08.Models.Patient", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPatient = 1,
                            BirthDate = new DateTime(1998, 1, 17, 22, 5, 23, 153, DateTimeKind.Local).AddTicks(5044),
                            FirstName = "Angela",
                            LastName = "Martin"
                        },
                        new
                        {
                            IdPatient = 2,
                            BirthDate = new DateTime(2002, 1, 17, 22, 5, 23, 153, DateTimeKind.Local).AddTicks(5106),
                            FirstName = "Pam",
                            LastName = "Halpert"
                        });
                });
            ...
            modelBuilder.Entity("Task08.Models.Prescription", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPrescription = 1,
                            Date = new DateTime(2023, 1, 17, 22, 5, 23, 155, DateTimeKind.Local).AddTicks(8034),
                            DueDate = new DateTime(2023, 4, 17, 22, 5, 23, 155, DateTimeKind.Local).AddTicks(8058),
                            IdDoctor = 1,
                            IdPatient = 1
                        },
                        new
                        {
                            IdPrescription = 2,
                            Date = new DateTime(2023, 1, 17, 22, 5, 23, 155, DateTimeKind.Local).AddTicks(8070),
                            DueDate = new DateTime(2023, 4, 17, 22, 5, 23, 155, DateTimeKind.Local).AddTicks(8074),
                            IdDoctor = 1,
                            IdPatient = 2
                        });
                });
