...
namespace Task08.Migrations
{
    ...
    [Migration("20230117213107_addedUserTable2")]
            ...
            modelBuilder.Entity("Task08.Models.Patient", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPatient = 1,
                            BirthDate = new DateTime(1998, 1, 17, 22, 31, 7, 675, DateTimeKind.Local).AddTicks(349),
                            FirstName = "Angela",
                            LastName = "Martin"
                        },
                        new
                        {
                            IdPatient = 2,
                            BirthDate = new DateTime(2002, 1, 17, 22, 31, 7, 675, DateTimeKind.Local).AddTicks(401),
                            FirstName = "Pam",
                            LastName = "Halpert"
                        });
                });
            ...
            modelBuilder.Entity("Task08.Models.Prescription", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPrescription = 1,
                            Date = new DateTime(2023, 1, 17, 22, 31, 7, 676, DateTimeKind.Local).AddTicks(6479),
                            DueDate = new DateTime(2023, 4, 17, 22, 31, 7, 676, DateTimeKind.Local).AddTicks(6493),
                            IdDoctor = 1,
                            IdPatient = 1
                        },
                        new
                        {
                            IdPrescription = 2,
                            Date = new DateTime(2023, 1, 17, 22, 31, 7, 676, DateTimeKind.Local).AddTicks(6502),
                            DueDate = new DateTime(2023, 4, 17, 22, 31, 7, 676, DateTimeKind.Local).AddTicks(6505),
                            IdDoctor = 1,
                            IdPatient = 2
                        });
                });
